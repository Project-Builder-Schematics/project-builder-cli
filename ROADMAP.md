...
| 5 | `builder init` end-to-end | M | angular-adapter | First real command: generates `project-builder.json` + skill stub + folder structure + package.json script alias. Augment-mode only (per inventory revision; scaffolding from scratch lives in #10). | 📋 PENDING — after #4 |
